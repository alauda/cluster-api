...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*corev1alpha4.ObjectMeta)(nil), (*clusterapiapiv1beta1.ObjectMeta)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_ObjectMeta_To_v1beta1_ObjectMeta(a.(*corev1alpha4.ObjectMeta), b.(*clusterapiapiv1beta1.ObjectMeta), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*clusterapiapiv1beta1.ObjectMeta)(nil), (*corev1alpha4.ObjectMeta)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ObjectMeta_To_v1alpha4_ObjectMeta(a.(*clusterapiapiv1beta1.ObjectMeta), b.(*corev1alpha4.ObjectMeta), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha4_KubeadmControlPlaneSpec_To_v1beta1_KubeadmControlPlaneSpec(in *KubeadmControlPlaneSpec, out *v1beta1.KubeadmControlPlaneSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha4_KubeadmConfigSpec_To_v1beta1_KubeadmConfigSpec(&in.KubeadmConfigSpec, &out.KubeadmConfigSpec, s); err != nil {
		return err
	}
